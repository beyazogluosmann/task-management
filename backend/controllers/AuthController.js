...
export class AuthController {
  ...
  static async getCurrentUser(req, res) {
    try {
      ...
      const user = await Auth.findUserById(req.user._id);
      if (!user) {
  ...
  static async forgotPassword(req, res) {
    try {
      ...
      await Auth.updateResetToken(user._id, resetToken, resetTokenExpiry);
  ...
  static async resetPassword(req, res) {
    try {
      ...
      await Auth.updatePassword(user._id, hashedPassword);
